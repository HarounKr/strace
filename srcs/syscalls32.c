...
t_syscall syscalls32[] = {
    ...
    {114, "wait4", 4, {"int", "int *", "int", "addr"}, "int"},
    ...
    {187, "sendfile", 4, {"int", "int", "int *", "unsigned int"}, "long"},
    ...
    {275, "get_mempolicy", 5, {"int *", "int *", "unsigned long", "void", "unsigned long"}, "long"},
    {276, "set_mempolicy", 3, {"int", "int *", "unsigned long"}, "long"},
