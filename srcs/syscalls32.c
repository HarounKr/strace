...
t_syscall syscalls32[] = {
    {0, "restart_syscall", 0, {NULL}, "long"},
    {1, "exit", 1, {"int"}, "void"},
    {2, "fork", 0, {NULL}, "int"},
    {3, "read", 3, {"int", "char *", "unsigned long"}, "long"},
    {4, "write", 3, {"int", "char *", "unsigned long"}, "long"},
    ...
    {75, "setrlimit", 2, {"int", "addr"}, "int"},
    {76, "getrlimit", 2, {"int", "addr"}, "int"},
    {77, "getrusage", 2, {"int", "addr"}, "int"},
    {78, "gettimeofday", 2, {"addr", "addr"}, "int"},
    {79, "settimeofday", 2, {"addr", "addr"}, "int"},
    {80, "getgroups", 2, {"int", "unsigned int"}, "int"},
    {81, "setgroups", 2, {"unsigned long", "unsigned int"}, "int"},
    {82, "select", 5, {"int", "addr", "addr", "addr", "addr"}, "int"},
    ...
    {89, "readdir", 3, {"unsigned int", "addr", "unsigned int"}, "int"},
    ...
    {99, "statfs", 2, {"char *", "addr"}, "int"},
    {100, "fstatfs", 2, {"int", "addr"}, "int"},
    {101, "ioperm", 3, {"unsigned long", "unsigned long", "int"}, "int"},
    {102, "socketcall", 2, {"int", "unsigned long"}, "int"},
    {103, "syslog", 3, {"int", "char *", "int"}, "int"},
    {104, "setitimer", 3, {"int", "addr", "addr"}, "int"},
    {105, "getitimer", 2, {"int", "addr"}, "int"},
    {106, "stat", 2, {"char *", "addr"}, "int"},
    {107, "lstat", 2, {"char *", "addr"}, "int"},
    {108, "fstat", 2, {"int", "addr"}, "int"},
    {109, "oldolduname", 1, {"addr"}, "int"},
    {110, "iopl", 1, {"int"}, "int"},
    {111, "vhangup", 0, {NULL}, "int"},
    {112, "idle", 0, {NULL}, "int"},
    {113, "vm86old", 1, {"addr"}, "int"},
    {114, "wait4", 4, {"int", "addr", "int", "addr"}, "int"},
    {115, "swapoff", 1, {"char *"}, "int"},
    {116, "sysinfo", 1, {"addr"}, "int"},
    {117, "ipc", 6, {"unsigned int", "int", "int", "int", "void", "long"}, "int"},
    {118, "fsync", 1, {"int"}, "int"},
    {119, "sigreturn", 1, {"..."}, "int"},
    {120, "clone", 3, {"addr", "void *", "int"}, "int"},
    {121, "setdomainname", 2, {"char *", "unsigned long"}, "int"},
    {122, "uname", 1, {"addr"}, "int"},
    {123, "modify_ldt", 3, {"int", "void", "unsigned long"}, "int"},
    {124, "adjtimex", 1, {"addr"}, "int"},
    ...
    {130, "get_kernel_syms", 1, {"addr"}, "int"},
    ...
    {161, "sched_rr_get_interval", 2, {"int", "addr"}, "int"},
    {162, "nanosleep", 2, {"addr", "addr"}, "int"},
    ...
    {166, "vm86", 2, {"unsigned long", "addr"}, "int"},
    {167, "query_module", 5, {"char *", "int", "void", "unsigned long", "unsigned long"}, "int"},
    {168, "poll", 3, {"addr", "addr", "int"}, "int"},
    {169, "nfsservctl", 3, {"int", "addr", "union nfsctl_res"}, "long"},
    ...
    {180, "pread64", 4, {"int", "char *", "unsigned long", "long"}, "long"},
    {181, "pwrite64", 4, {"int", "char *", "unsigned long", "long"}, "long"},
    ...
    {187, "sendfile", 4, {"int", "int", "addr", "unsigned int"}, "long"},
    ...
    {241, "sched_setaffinity", 3, {"int", "unsigned long", "addr"}, "int"},
    {242, "sched_getaffinity", 3, {"int", "unsigned long", "addr"}, "int"},
    {243, "set_thread_area", 1, {"addr"}, "int"},
    {244, "get_thread_area", 1, {"addr"}, "int"},
    {245, "io_setup", 2, {"unsigned", "unsigned int"}, "long"},
    {246, "io_destroy", 1, {"unsigned int"}, "int"},
    {247, "io_getevents", 5, {"unsigned int", "long", "long", "addr", "addr"}, "int"},
    {248, "io_submit", 3, {"unsigned int", "long", "addr"}, "int"},
    {249, "io_cancel", 3, {"unsigned int", "addr", "addr"}, "int"},
    ...
    {255, "epoll_ctl", 4, {"int", "int", "int", "addr"}, "int"},
    {256, "epoll_wait", 4, {"int", "addr", "int", "int"}, "int"},
    {257, "remap_file_pages", 5, {"void", "unsigned long", "int", "unsigned long", "int"}, "int"},
    {258, "set_tid_addr", 1, {"addr"}, "int"},
    {259, "timer_create", 3, {"addr", "addr", "addr"}, "int"},
    {260, "timer_settime", 4, {"addr", "int", "addr", "addr"}, "int"},
    {261, "timer_gettime", 2, {"addr", "addr"}, "int"},
    {262, "timer_getoverrun", 1, {"addr"}, "int"},
    {263, "timer_delete", 1, {"addr"}, "int"},
    {264, "clock_settime", 2, {"addr", "addr"}, "int"},
    {265, "clock_gettime", 2, {"addr", "addr"}, "int"},
    {266, "clock_getres", 2, {"addr", "addr"}, "int"},
    {267, "clock_nanosleep", 4, {"addr", "int", "addr", "addr"}, "int"},
    {268, "statfs64", 2, {"addr", "addr"}, "int"},
    {269, "fstatfs64", 2, {"int", "addr"}, "int"},
    {270, "tgkill", 3, {"int", "int", "int"}, "int"},
    {271, "utimes", 2, {"char *", "addr"}, "int"},
    ...
    {275, "get_mempolicy", 5, {"addr", "addr", "unsigned long", "void", "unsigned long"}, "long"},
    {276, "set_mempolicy", 3, {"int", "addr", "unsigned long"}, "long"},
    {277, "mq_open", 2, {"char *", "int"}, "mqd_t"},
    {278, "mq_unlink", 1, {"char *"}, "int"},
    {279, "mq_timedsend", 5, {"mqd_t", "char *", "unsigned long", "unsigned int", "addr"}, "int"},
    {280, "mq_timedreceive", 5, {"mqd_t", "char *", "unsigned long", "unsigned int", "addr"}, "long"},
    {281, "mq_notify", 2, {"mqd_t", "addr"}, "int"},
    {282, "mq_getsetattr", 3, {"mqd_t", "addr", "addr"}, "int"},
    {283, "kexec_load", 4, {"unsigned long", "unsigned long", "addr", "unsigned long"}, "long"},
    {284, "waitid", 4, {"addr", "unsigned int", "addr", "int"}, "int"},
    {286, "add_key", 5, {"char *", "char *", "void", "unsigned long", "int"}, "int"},
    {287, "request_key", 4, {"char *", "char *", "char *", "int"}, "int"},
    ...
    {299, "futimesat", 3, {"int", "char *", "addr"}, "int"},
    ...
    {309, "ppoll", 4, {"addr", "addr", "addr", "addr"}, "int"},
    {310, "unshare", 1, {"int"}, "int"},
    {311, "set_robust_list", 2, {"addr", "unsigned long"}, "long"},
    {312, "get_robust_list", 3, {"int", "addr", "unsigned long"}, "long"},
    ...
    {316, "vmsplice", 4, {"int", "addr", "unsigned long", "unsigned int"}, "long"},
    {317, "move_pages", 6, {"int", "unsigned long", "void **", "int", "int", "int"}, "long"},
    {318, "getcpu", 3, {"addr", "addr", "addr"}, "int"},
    {319, "epoll_pwait", 5, {"int", "addr", "int", "int", "addr"}, "int"},
    {320, "utimensat", 4, {"int", "char *", "addr", "int"}, "int"},
    ...
    {325, "timerfd_settime", 4, {"int", "int", "addr", "addr"}, "int"},
    {326, "timerfd_gettime", 2, {"int", "addr"}, "int"},
    ...
    {331, "pipe2", 2, {"addr", "int"}, "int"},
    {332, "inotify_init1", 1, {"int"}, "int"},
    {333, "preadv", 4, {"int", "addr", "int", "long"}, "long"},
    {334, "pwritev", 4, {"int", "addr", "int", "long"}, "long"},
    {335, "rt_tgsigqueueinfo", 4, {"int", "int", "int", "addr"}, "int"},
    {336, "perf_event_open", 5, {"addr", "int", "int", "int", "unsigned long"}, "int"},
    {337, "recvmmsg", 5, {"int", "addr", "unsigned int", "int", "addr"}, "int"},
    ...
    {341, "name_to_handle_at", 5, {"int", "char *", "addr", "int", "int"}, "int"},
    {342, "open_by_handle_at", 3, {"int", "addr", "int"}, "int"},
    {343, "clock_adjtime", 2, {"addr", "addr"}, "int"},
    {344, "syncfs", 1, {"int"}, "int"},
    {345, "sendmmsg", 4, {"int", "addr", "unsigned int", "int"}, "int"},
    {346, "setns", 2, {"int", "int"}, "int"},
    {347, "process_vm_readv", 6, {"int", "addr", "unsigned long", "addr", "unsigned long", "unsigned long"}, "long"},
    {348, "process_vm_writev", 6, {"int", "addr", "unsigned long", "addr", "unsigned long", "unsigned long"}, "long"},
    {349, "kcmp", 5, {"int", "int", "int", "unsigned long", "unsigned long"}, "int"},
    {350, "finit_module", 3, {"int", "char *", "int"}, "int"},
    {351, "sched_setattr", 3, {"int", "addr", "unsigned int"}, "int"},
    {352, "sched_getattr", 4, {"int", "addr", "unsigned int", "unsigned int"}, "int"},
    ...
    {361, "bind", 3, {"int", "addr", "unsigned int"}, "int"},
    {362, "connect", 3, {"int", "addr", "unsigned int"}, "int"},
    {363, "listen", 2, {"int", "int"}, "int"},
    {364, "accept4", 4, {"int", "addr", "unsigned int", "int"}, "int"},
    {365, "getsockopt", 5, {"int", "int", "int", "void", "unsigned int"}, "int"},
    {366, "setsockopt", 5, {"int", "int", "int", "void", "unsigned int"}, "int"},
    {367, "getsockname", 3, {"int", "addr", "unsigned int"}, "int"},
    {368, "getpeername", 3, {"int", "addr", "unsigned int"}, "int"},
    {369, "sendto", 6, {"int", "void", "unsigned long", "int", "addr", "unsigned int"}, "long"},
    {370, "sendmsg", 3, {"int", "addr", "int"}, "long"},
    {371, "recvfrom", 6, {"int", "void", "unsigned long", "int", "addr", "unsigned int"}, "long"},
    {372, "recvmsg", 3, {"int", "addr", "int"}, "long"},
