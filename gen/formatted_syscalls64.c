...
t_syscall syscalls64[] = { 
    ...
    {17, {"pread64", 4, {"int", "addr", "unsigned long", "long"}, "long"}},
    {18, {"pwrite64", 4, {"int", "addr", "unsigned long", "long"}, "long"}},
    ...
    {262, {"newfstatat", 4, {"int", "addr", "addr", "int"}, "int"}},
    ...
    {435, {"clone3", 2, {"addr", "unsigned int"}, "int"}},
    {436, {"close_range", 3, {"unsigned int", "unsigned int", "unsigned int"}, "int"}},
    {437, {"openat2", 3, {"int", "addr", "addr"}, "int"}},
    {438, {"pidfd_getfd", 3, {"int", "int", "unsigned int"}, "int"}},
    {439, {"faccessat2", 4, {"int", "addr", "int", "unsigned int"}, "int"}},
