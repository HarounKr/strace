t_syscall syscalls[] = {
    {0, {"read", 3, {"int", "void", "unsigned long"}, "long"}},
    {1, {"write", 3, {"int", "void", "unsigned long"}, "long"}},
    {2, {"open", 2, {"char", "int"}, "int"}},
    {3, {"close", 1, {"int"}, "int"}},
    {4, {"stat", 2, {"char", "addr stat"}, "int"}},
    {5, {"fstat", 2, {"int", "addr stat"}, "int"}},
    {6, {"lstat", 2, {"char", "addr stat"}, "int"}},
    {7, {"poll", 3, {"addr pollfd", "addr", "int"}, "int"}},
    ...
    {12, {"brk", 1, {"void"}, "int"}},
    {13, {"rt_sigaction", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {14, {"rt_sigprocmask", 4, {"int", "addr", "addr", "unsigned long"}, "int"}},
    {15, {"rt_sigreturn", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {16, {"ioctl", 3, {"int", "unsigned long", "..."}, "int"}},
    {17, {"pread64", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {18, {"pwrite64", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {19, {"readv", 3, {"int", "addr iovec", "int"}, "long"}},
    {20, {"writev", 3, {"int", "addr iovec", "int"}, "long"}},
    {21, {"access", 2, {"char", "int"}, "int"}},
    {22, {"pipe", 0, {NULL}, "addr fd_pair"}},
    {23, {"select", 5, {"int", "addr", "addr", "addr", "addr timeval"}, "int"}},
    {24, {"sched_yield", 0, {NULL}, "int"}},
    {25, {"mremap", 5, {"void", "unsigned long", "unsigned long", "int", "... /* void *new_address"}, "void *"}},
    {26, {"msync", 3, {"void", "unsigned long", "int"}, "int"}},
    {27, {"mincore", 3, {"void", "unsigned long", "unsigned char"}, "int"}},
    {28, {"madvise", 3, {"void", "unsigned long", "int"}, "int"}},
    {29, {"shmget", 3, {"addr", "unsigned long", "int"}, "int"}},
    {30, {"shmat", 3, {"int", "void", "int"}, "void *"}},
    {31, {"shmctl", 3, {"int", "int", "addr shmid_ds"}, "int"}},
    {32, {"dup", 1, {"int"}, "int"}},
    {33, {"dup2", 2, {"int", "int"}, "int"}},
    {34, {"pause", 0, {NULL}, "int"}},
    {35, {"nanosleep", 2, {"addr timespec", "addr timespec"}, "int"}},
    {36, {"getitimer", 2, {"int", "addr itimerval"}, "int"}},
    {37, {"alarm", 1, {"unsigned int"}, "unsigned int"}},
    {38, {"setitimer", 3, {"int", "addr itimerval", "addr itimerval"}, "int"}},
    {39, {"getpid", 0, {NULL}, "int"}},
    {40, {"sendfile", 4, {"int", "int", "long", "unsigned long"}, "long"}},
    {41, {"socket", 3, {"int", "int", "int"}, "int"}},
    {42, {"connect", 3, {"int", "addr sockaddr", "unsigned int"}, "int"}},
    {43, {"accept", 3, {"int", "addr sockaddr", "unsigned int"}, "int"}},
    {44, {"sendto", 6, {"int", "void", "unsigned long", "int", "addr sockaddr", "unsigned int"}, "long"}},
    {45, {"recvfrom", 6, {"int", "void", "unsigned long", "int", "addr sockaddr", "unsigned int"}, "long"}},
    {46, {"sendmsg", 3, {"int", "addr msghdr", "int"}, "long"}},
    {47, {"recvmsg", 3, {"int", "addr msghdr", "int"}, "long"}},
    {48, {"shutdown", 2, {"int", "int"}, "int"}},
    {49, {"bind", 3, {"int", "addr sockaddr", "unsigned int"}, "int"}},
    {50, {"listen", 2, {"int", "int"}, "int"}},
    {51, {"getsockname", 3, {"int", "addr sockaddr", "unsigned int"}, "int"}},
    {52, {"getpeername", 3, {"int", "addr sockaddr", "unsigned int"}, "int"}},
    ...
    {60, {"exit", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {61, {"wait4", 4, {"int", "int", "int", "addr rusage"}, "int"}},
    {62, {"kill", 2, {"int", "int"}, "int"}},
    {63, {"uname", 1, {"addr utsname"}, "int"}},
    {64, {"semget", 3, {"addr", "int", "int"}, "int"}},
    {65, {"semop", 3, {"int", "addr sembuf", "unsigned long"}, "int"}},
    ...
    {71, {"msgctl", 3, {"int", "int", "addr msqid_ds"}, "int"}},
    {72, {"fcntl", 3, {"int", "int", "... /* arg"}, "int"}},
    {73, {"flock", 2, {"int", "int"}, "int"}},
    {74, {"fsync", 1, {"int"}, "int"}},
    {75, {"fdatasync", 1, {"int"}, "int"}},
    {76, {"truncate", 2, {"char", "long"}, "int"}},
    {77, {"ftruncate", 2, {"int", "long"}, "int"}},
    {78, {"getdents", 3, {"unsigned int", "addr linux_dirent", "unsigned int"}, "long"}},
    ...
    {96, {"gettimeofday", 2, {"addr timeval", "addr timezone"}, "int"}},
    {97, {"getrlimit", 2, {"int", "addr rlimit"}, "int"}},
    {98, {"getrusage", 2, {"int", "addr rusage"}, "int"}},
    {99, {"sysinfo", 1, {"addr sysinfo"}, "int"}},
    {100, {"times", 1, {"addr tms"}, "clock_t"}},
    {101, {"ptrace", 4, {"enum __ptrace_request", "int", "void", "void"}, "long"}},
    ...
    {127, {"rt_sigpending", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {128, {"rt_sigtimedwait", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {129, {"rt_sigqueueinfo", 3, {"int", "int", "addr"}, "int"}},
    {130, {"rt_sigsuspend", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {131, {"sigaltstack", 2, {"stack_t", "stack_t"}, "int"}},
    {132, {"utime", 2, {"char", "addr utimbuf"}, "int"}},
    {133, {"mknod", 3, {"char", "unsigned int", "addr"}, "int"}},
    {134, {"uselib", 1, {"char"}, "int"}},
    {135, {"personality", 1, {"unsigned long"}, "int"}},
    {136, {"ustat", 2, {"addr", "addr ustat"}, "int"}},
    {137, {"statfs", 2, {"char", "addr statfs"}, "int"}},
    {138, {"fstatfs", 2, {"int", "addr statfs"}, "int"}},
    {139, {"sysfs", 2, {"int", "char"}, "int"}},
    {140, {"getpriority", 2, {"int", "unsigned int"}, "int"}},
    {141, {"setpriority", 3, {"int", "unsigned int", "int"}, "int"}},
    {142, {"sched_setparam", 2, {"int", "addr sched_param"}, "int"}},
    {143, {"sched_getparam", 2, {"int", "addr sched_param"}, "int"}},
    {144, {"sched_setscheduler", 3, {"int", "int", "addr sched_param"}, "int"}},
    {145, {"sched_getscheduler", 1, {"int"}, "int"}},
    {146, {"sched_get_priority_max", 1, {"int"}, "int"}},
    {147, {"sched_get_priority_min", 1, {"int"}, "int"}},
    {148, {"sched_rr_get_interval", 2, {"int", "addr timespec"}, "int"}},
    ...
    {177, {"get_kernel_syms", 1, {"addr kernel_sym"}, "int"}},
    {178, {"query_module", 5, {"char", "int", "void", "unsigned long", "unsigned long"}, "int"}},
    {179, {"quotactl", 4, {"int", "char", "int", "unsigned long"}, "int"}},
    {180, {"nfsservctl", 3, {"int", "addr nfsctl_arg", "union nfsctl_res"}, "long"}},
    {181, {"getpmsg", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {182, {"putpmsg", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {183, {"afs_syscall", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {184, {"tuxcall", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {185, {"security", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    ...
    {202, {"futex", 6, {"unsigned int", "int", "unsigned int", "addr timespec", "/* or: unsigned int val2 */ unsigned int", "unsigned int"}, "long"}},
    {203, {"sched_setaffinity", 3, {"int", "unsigned long", "int"}, "int"}},
    {204, {"sched_getaffinity", 3, {"int", "unsigned long", "int"}, "int"}},
    {205, {"set_thread_area", 1, {"addr user_desc"}, "int"}},
    {206, {"io_setup", 2, {"unsigned", "unsigned int"}, "long"}},
    {207, {"io_destroy", 1, {"unsigned int"}, "int"}},
    {208, {"io_getevents", 5, {"unsigned int", "long", "long", "addr io_event", "addr timespec"}, "int"}},
    {209, {"io_submit", 3, {"unsigned int", "long", "addr iocb"}, "int"}},
    {210, {"io_cancel", 3, {"unsigned int", "addr iocb", "addr io_event"}, "int"}},
    {211, {"get_thread_area", 1, {"addr user_desc"}, "int"}},
    {212, {"lookup_dcookie", 3, {"unsigned int", "char", "unsigned long"}, "int"}},
    {213, {"epoll_create", 1, {"int"}, "int"}},
    {214, {"epoll_ctl_old", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {215, {"epoll_wait_old", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    ...
    {220, {"semtimedop", 4, {"int", "addr sembuf", "unsigned long", "addr timespec"}, "int"}},
    {221, {"fadvise64", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {222, {"timer_create", 3, {"addr", "addr sigevent", "addr"}, "int"}},
    {223, {"timer_settime", 4, {"addr", "int", "addr itimerspec", "addr itimerspec"}, "int"}},
    {224, {"timer_gettime", 2, {"addr", "addr itimerspec"}, "int"}},
    {225, {"timer_getoverrun", 1, {"addr"}, "int"}},
    {226, {"timer_delete", 1, {"addr"}, "int"}},
    {227, {"clock_settime", 2, {"addr", "addr timespec"}, "int"}},
    {228, {"clock_gettime", 2, {"addr", "addr timespec"}, "int"}},
    {229, {"clock_getres", 2, {"addr", "addr timespec"}, "int"}},
    {230, {"clock_nanosleep", 4, {"addr", "int", "addr timespec", "addr timespec"}, "int"}},
    {231, {"exit_group", 1, {"int"}, "void"}},
    {232, {"epoll_wait", 4, {"int", "addr epoll_event", "int", "int"}, "int"}},
    {233, {"epoll_ctl", 4, {"int", "int", "int", "addr epoll_event"}, "int"}},
    {234, {"tgkill", 3, {"int", "int", "int"}, "int"}},
    {235, {"utimes", 2, {"char", "addr timeval"}, "int"}},
    {236, {"vserver", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {237, {"mbind", 6, {"void", "unsigned long", "int", "unsigned long", "unsigned long", "unsigned"}, "long"}},
    {238, {"set_mempolicy", 3, {"int", "unsigned long", "unsigned long"}, "long"}},
    {239, {"get_mempolicy", 5, {"int", "unsigned long", "unsigned long", "void", "unsigned long"}, "long"}},
    {240, {"mq_open", 2, {"char", "int"}, "mqd_t"}},
    {241, {"mq_unlink", 1, {"char"}, "int"}},
    {242, {"mq_timedsend", 5, {"mqd_t", "char", "unsigned long", "unsigned int", "addr timespec"}, "int"}},
    {243, {"mq_timedreceive", 5, {"mqd_t", "char", "unsigned long", "unsigned int", "addr timespec"}, "long"}},
    {244, {"mq_notify", 2, {"mqd_t", "addr sigevent"}, "int"}},
    {245, {"mq_getsetattr", 3, {"mqd_t", "addr mq_attr", "addr mq_attr"}, "int"}},
    {246, {"kexec_load", 4, {"unsigned long", "unsigned long", "addr kexec_segment", "unsigned long"}, "long"}},
    {247, {"waitid", 4, {"idtype_t", "unsigned int", "addr", "int"}, "int"}},
    {248, {"add_key", 5, {"char", "char", "void", "unsigned long", "key_serial_t"}, "key_serial_t"}},
    {249, {"request_key", 4, {"char", "char", "char", "key_serial_t"}, "key_serial_t"}},
    ...
    {261, {"futimesat", 3, {"int", "char", "addr timeval"}, "int"}},
    {262, {"newfstatat", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    ...
    {270, {"pselect6", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {271, {"ppoll", 4, {"addr pollfd", "addr", "addr timespec", "addr"}, "int"}},
    {272, {"unshare", 1, {"int"}, "int"}},
    {273, {"set_robust_list", 2, {"addr robust_list_head", "unsigned long"}, "long"}},
    {274, {"get_robust_list", 3, {"int", "addr robust_list_head", "unsigned long"}, "long"}},
    ...
    {278, {"vmsplice", 4, {"int", "addr iovec", "unsigned long", "unsigned int"}, "long"}},
    {279, {"move_pages", 6, {"int", "unsigned long", "void", "int", "int", "int"}, "long"}},
    {280, {"utimensat", 4, {"int", "char", "addr timespec", "int"}, "int"}},
    {281, {"epoll_pwait", 5, {"int", "addr epoll_event", "int", "int", "addr"}, "int"}},
    ...
    {286, {"timerfd_settime", 4, {"int", "int", "addr itimerspec", "addr itimerspec"}, "int"}},
    {287, {"timerfd_gettime", 2, {"int", "addr itimerspec"}, "int"}},
    {288, {"accept4", 4, {"int", "addr sockaddr", "unsigned int", "int"}, "int"}},
    {289, {"signalfd4", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {290, {"eventfd2", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {291, {"epoll_create1", 1, {"int"}, "int"}},
    {292, {"dup3", 3, {"int", "int", "int"}, "int"}},
    {293, {"pipe2", 2, {"int", "int"}, "int"}},
    {294, {"inotify_init1", 1, {"int"}, "int"}},
    {295, {"preadv", 4, {"int", "addr iovec", "int", "long"}, "long"}},
    {296, {"pwritev", 4, {"int", "addr iovec", "int", "long"}, "long"}},
    {297, {"rt_tgsigqueueinfo", 4, {"int", "int", "int", "addr"}, "int"}},
    {298, {"perf_event_open", 5, {"addr perf_event_attr", "int", "int", "int", "unsigned long"}, "int"}},
    {299, {"recvmmsg", 5, {"int", "addr mmsghdr", "unsigned int", "int", "addr timespec"}, "int"}},
    {300, {"fanotify_init", 2, {"unsigned int", "unsigned int"}, "int"}},
    {301, {"fanotify_mark", 5, {"int", "unsigned int", "unsigned long", "int", "char"}, "int"}},
    {302, {"prlimit64", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {303, {"name_to_handle_at", 5, {"int", "char", "addr file_handle", "int", "int"}, "int"}},
    {304, {"open_by_handle_at", 3, {"int", "addr file_handle", "int"}, "int"}},
    {305, {"clock_adjtime", 2, {"addr", "addr timex"}, "int"}},
    {306, {"syncfs", 1, {"int"}, "int"}},
    {307, {"sendmmsg", 4, {"int", "addr mmsghdr", "unsigned int", "int"}, "int"}},
    {308, {"setns", 2, {"int", "int"}, "int"}},
    {309, {"getcpu", 3, {"unsigned", "unsigned", "addr getcpu_cache"}, "int"}},
    {310, {"process_vm_readv", 6, {"int", "addr iovec", "unsigned long", "addr iovec", "unsigned long", "unsigned long"}, "long"}},
    {311, {"process_vm_writev", 6, {"int", "addr iovec", "unsigned long", "addr iovec", "unsigned long", "unsigned long"}, "long"}},
    {312, {"kcmp", 5, {"int", "int", "int", "unsigned long", "unsigned long"}, "int"}},
    {313, {"finit_module", 3, {"int", "char", "int"}, "int"}},
    {314, {"sched_setattr", 3, {"int", "addr sched_attr", "unsigned int"}, "int"}},
    {315, {"sched_getattr", 4, {"int", "addr sched_attr", "unsigned int", "unsigned int"}, "int"}},
    ...
    {327, {"preadv2", 5, {"int", "addr iovec", "int", "long", "int"}, "long"}},
    {328, {"pwritev2", 5, {"int", "addr iovec", "int", "long", "int"}, "long"}},
    {329, {"pkey_mprotect", 4, {"void", "unsigned long", "int", "int"}, "int"}},
    {330, {"pkey_alloc", 2, {"unsigned int", "unsigned int"}, "int"}},
    {331, {"pkey_free", 1, {"int"}, "int"}},
    {332, {"statx", 5, {"int", "char", "int", "unsigned int", "addr statx"}, "int"}},
    {333, {"io_pgetevents", 0, {NULL}, "int"}} /* syscall pas trouvé */,
    {334, {"rseq", 0, {NULL}, "int"}} /* syscall pas trouvé */,
